...
if (isset($_POST['submit'])) {
    ...
    //print_r('<br>');
    //print_r('série:    ' . $_POST['série']);
    //print_r('<br>');
    //print_r('data_ nascimento:  ' . $_POST['data_nascimento']);
    //print_r('<br>');
    ...
    $result = mysqli_query($conexao, "INSERT INTO usuarios(nome,email,telefone,série,data_nascimento,endereço,cidade,estado)
     VALUES ('$nome','$email','$telefone','$série','$data_nascimento','$endereço','$cidade','$estado')");
